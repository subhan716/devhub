...
import { TerminalSquare, Mail, Lock, ArrowRight, Sun, Moon } from 'lucide-react';
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        await axios.get(`${import.meta.env.VITE_API_URL}/api/profile/me`);
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0A0A0A] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-200">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="text-center text-3xl font-extrabold text-slate-900 dark:text-white">Access Your Workspace</h2>
        <p className="mt-2 text-center text-sm text-slate-600 dark:text-gray-400">
          New to DevHub?{' '}
          <Link to="/register" className="font-medium text-[#0A66C2] dark:text-[#00F0FF] hover:underline transition-colors">
          ...
          <form className="space-y-6" onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex items-center justify-end">
              <div className="text-sm">
                <a href="#" className="font-medium text-[#0A66C2] dark:text-[#00F0FF] hover:underline">
